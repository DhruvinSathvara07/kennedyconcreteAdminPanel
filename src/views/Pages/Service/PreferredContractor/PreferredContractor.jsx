...
const PreferredContractor = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.post('http://localhost:5000/preferredcontractors', formData, {
        headers: {
      ...
      reset()
      navigate('/theme/preferredcontractor/list') // Updated navigation path
    } catch (error) {
  ...
  return (
    <div>
      <div className="container my-5">
        <h1 className="mb-5">Preferred Contractor</h1>
        <div className="row">
          <div className="col-lg-12">
            <form className="form-control shadow py-5" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mb-3">
                ...
                />
                {errors.redtitletwo && (
                  <span className="text-danger">Red Title Two is required</span>
                )}
              </div>
...
export default PreferredContractor
