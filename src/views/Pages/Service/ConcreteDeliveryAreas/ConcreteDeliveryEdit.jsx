...
const ConcreteDeliveryEdit = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.put(`http://localhost:5000/delivery/${id}`, formData, {
        headers: {
  ...
  return (
    <div className="container my-5">
      <h1 className="mb-5">Edit Concrete Delivery Areas</h1>
      <div className="row">
          ...
          <form className="form-control shadow py-5" onSubmit={handleSubmit(onSubmit)}>
            <div className="mb-3">
              ...
              {/* {initialData?.heroimg && (
                <div className="mb-2">
                  <img
                    src={`http://localhost:5000/uploads/${initialData.heroimg}`}
                    alt="Current hero"
            ...
            <div className="d-flex gap-2">
              ...
              <button
                ...
                onClick={() => navigate('/theme/concrete/list')}
              >
                Cancel
              </button>
            </div>
...
export default ConcreteDeliveryEdit
