...
const ConcreteDeliveryAreas = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.post('http://localhost:5000/delivery', formData, {
        headers: {
  ...
  return (
    <div className="container my-5">
      <h1 className="mb-5">Concrete Delivery Areas</h1>
      <div className="row">
...
export default ConcreteDeliveryAreas
