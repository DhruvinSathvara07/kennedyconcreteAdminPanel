...
const CellfillList = () => {
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this item?')) {
      try {
        await axios.delete(`http://localhost:5000/cellfill/${id}`)
    ...
    <div>
      <div className="my-5">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <h1>Cellfill List</h1>
          <button className="btn btn-success" onClick={() => navigate('/theme/cellfill/page')}>
            Add New Item
          </button>
        </div>
                      ...
                      <td>
                        <div className="d-flex gap-2">
                          <i
                            ...
                            onClick={() => navigate(`/theme/cellfill/list/${item._id}`)}
                            title="Edit"
                          ></i>
                          <i
