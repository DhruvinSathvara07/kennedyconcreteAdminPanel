...
const SlabEdit = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.put(`http://localhost:5000/decorative/${id}`, formData, {
        headers: {
      ...
      navigate('/theme/decorative/list')
    } catch (error) {
  ...
  return (
    <div className="container my-5">
      <h1 className="mb-5">Edit Decorative Concrete</h1>
      <div className="row">
          ...
          <form className="form-control shadow py-5" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="d-flex gap-2">
              ...
              <button
                ...
                onClick={() => navigate('/theme/decorative/list')}
              >
                Cancel
              </button>
            </div>
