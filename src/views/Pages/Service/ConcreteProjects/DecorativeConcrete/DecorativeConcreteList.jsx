...
const DecorativeConcreteList = () => {
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this item?')) {
      try {
        await axios.delete(`http://localhost:5000/decorative/${id}`)
                      ...
                      <td>
                        <div className="d-flex gap-2">
                          <i
                            ...
                            onClick={() => navigate(`/theme/decorative/list/${item._id}`)}
                            title="Edit"
                          ></i>
                          <i
...
export default DecorativeConcreteList
