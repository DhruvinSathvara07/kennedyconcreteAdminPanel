...
const DrivewayList = () => {
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this item?')) {
      try {
        await axios.delete(`http://localhost:5000/driveway/${id}`)
    ...
    <div>
      <div className="my-5">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <h1>Driveway</h1>
          <button className="btn btn-success" onClick={() => navigate('/theme/driveway/page')}>
            Add New Item
          </button>
        </div>
                      ...
                      <td>
                        <div className="d-flex gap-2">
                          <i
                            ...
                            onClick={() => navigate(`/theme/driveway/list/${item._id}`)}
                            title="Edit"
                          ></i>
                          <i
