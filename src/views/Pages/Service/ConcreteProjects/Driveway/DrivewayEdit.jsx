...
const DrivewayEdit = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.put(`http://localhost:5000/driveway/${id}`, formData, {
        headers: {
  ...
  return (
    <div className="container my-5">
      <h1 className="mb-5">Edit Driveway</h1>
      <div className="row">
          ...
          <form className="form-control shadow py-5" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="d-flex gap-2">
              <button
                ...
                onClick={() => navigate('/theme/driveway/list')}
              >
                Update
              </button>
